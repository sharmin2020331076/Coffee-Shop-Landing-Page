...
export function Cappuccino(){
    ...
    return(
        <div className="w-full min-h-screen grid lg:grid-cols-2 grid-cols-1 gap-4 lg:gap-8 items-center">
                <div className="p-14">
                    <div ref={textRef} className={`bg-yellow-100 rounded-3xl p-8 space-y-4 sm:space-y-6 order-2 lg:order-1 flex flex-col justify-center hover:shadow-2xl hover:scale-105 transition-all ease-out cursor-pointer ${textVisible ? 'animate-fade-in-left' : 'opacity-0'}`}>
